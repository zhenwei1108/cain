package com.github.wegoo.cain.mozilla;
...
import com.github.wegoo.cain.asn1.mozilla.PublicKeyAndChallenge;
...
{
    protected final com.github.wegoo.cain.asn1.mozilla.SignedPublicKeyAndChallenge          spkacSeq;

    public SignedPublicKeyAndChallenge(byte[] bytes)
    {
        spkacSeq = com.github.wegoo.cain.asn1.mozilla.SignedPublicKeyAndChallenge.getInstance(bytes);
    }

    protected SignedPublicKeyAndChallenge(com.github.wegoo.cain.asn1.mozilla.SignedPublicKeyAndChallenge struct)
    {
     ...
     */
    public com.github.wegoo.cain.asn1.mozilla.SignedPublicKeyAndChallenge toASN1Structure()
    {
         return spkacSeq;
    }
