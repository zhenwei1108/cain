...
import com.github.wegoo.cain.cert.X509AttributeCertificateHolder;
...
import com.github.wegoo.cain.pkcs.PKCS8EncryptedPrivateKeyInfo;
import com.github.wegoo.cain.util.encoders.Hex;
import com.github.wegoo.cain.util.io.pem.PemHeader;
import com.github.wegoo.cain.util.io.pem.PemObject;
import com.github.wegoo.cain.util.io.pem.PemObjectParser;
import com.github.wegoo.cain.util.io.pem.PemReader;
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.github.wegoo.cain.asn1.sec.ECPrivateKey pKey = com.github.wegoo.cain.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.github.wegoo.cain.asn1.pkcs.RSAPrivateKey keyStruct = com.github.wegoo.cain.asn1.pkcs.RSAPrivateKey.getInstance(seq);
