package com.github.wegoo.cain.pkix;
...
import com.github.wegoo.cain.asn1.x9.X9FieldID;
...
public class SubjectPublicKeyInfoChecker
{
    ...
    private static void validate(BigInteger modulus)
    {
        ...
        if (Properties.isOverrideSet("com.github.wegoo.cain.rsa.allow_unsafe_mod"))
        {
            return;
        }

        int maxBitLength = Properties.asInteger("com.github.wegoo.cain.rsa.max_size", 16384);
