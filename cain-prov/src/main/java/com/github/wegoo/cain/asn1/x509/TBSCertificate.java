    ...
    extends ASN1Object
{
    ...
    {
        if (Properties.getPropertyValue("com.github.wegoo.cain.x509.allow_non-der_tbscert") != null)
        {
            if (Properties.isOverrideSet("com.github.wegoo.cain.x509.allow_non-der_tbscert"))
            {
                return seq;
            }
        }
