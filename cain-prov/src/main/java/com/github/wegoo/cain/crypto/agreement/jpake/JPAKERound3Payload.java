package com.github.wegoo.cain.crypto.agreement.jpake;
...
public class JPAKERound3Payload
{
     ...
     *
     * @see JPAKEUtil#calculateMacTag(String, String, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, com.github.wegoo.cain.crypto.Digest)
     */
