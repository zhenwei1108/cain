...
import com.github.wegoo.cain.util.Bytes;
...
public class SM2Engine
{
        ...
        throws InvalidCipherTextException
    {
        ...
        byte[] c1;
        ECPoint kPB;
        BigInteger maxRange = ecParams.getN().subtract(BigInteger.ONE);
        do
        {
            BigInteger k = nextK(maxRange);
    ...
    private BigInteger nextK(BigInteger maxRange)
    {
        ...
        while (k.equals(BigIntegers.ZERO) || k.compareTo(maxRange) >= 0);
