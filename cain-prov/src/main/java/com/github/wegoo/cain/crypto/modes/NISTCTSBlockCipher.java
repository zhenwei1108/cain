    ...
    extends DefaultBufferedBlockCipher
{
     ...
     * @exception com.github.wegoo.cain.crypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @exception com.github.wegoo.cain.crypto.DataLengthException if there is insufficient space in out for
     * the output.
     * @exception IllegalStateException if the underlying cipher is not
     * initialised.
     * @exception com.github.wegoo.cain.crypto.InvalidCipherTextException if cipher text decrypts wrongly (in
