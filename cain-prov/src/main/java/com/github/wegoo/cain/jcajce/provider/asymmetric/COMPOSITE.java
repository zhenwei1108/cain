...
import com.github.wegoo.cain.jcajce.CompositePrivateKey;
...
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric.COMPOSITE";

    private static final Map<String, String> compositeAttributes = new HashMap<String, String>();

    static
    {
        compositeAttributes.put("SupportedKeyClasses", "com.github.wegoo.cain.jcajce.CompositePublicKey|com.github.wegoo.cain.jcajce.CompositePrivateKey");
