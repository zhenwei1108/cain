...
import com.github.wegoo.cain.jcajce.provider.asymmetric.dh.KeyFactorySpi;
...
public class DH
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric" + ".dh.";
