...
import com.github.wegoo.cain.jcajce.provider.asymmetric.dstu.KeyFactorySpi;
...
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric" + ".dstu.";
