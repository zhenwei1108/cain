...
import com.github.wegoo.cain.internal.asn1.cms.CMSObjectIdentifiers;
import com.github.wegoo.cain.internal.asn1.eac.EACObjectIdentifiers;
import com.github.wegoo.cain.jcajce.provider.asymmetric.ec.KeyFactorySpi;
...
public class EC
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric" + ".ec.";
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            if (!Properties.isOverrideSet("com.github.wegoo.cain.ec.disable_mqv"))
            {
