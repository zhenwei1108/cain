...
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric.EXTERNAL";

    private static final Map<String, String> externalAttributes = new HashMap<String, String>();

    static
    {
        externalAttributes.put("SupportedKeyClasses", "com.github.wegoo.cain.jcajce.ExternalPublicKey");
