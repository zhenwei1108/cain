...
import com.github.wegoo.cain.jcajce.provider.asymmetric.edec.KeyFactorySpi;
...
public class EdEC
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric" + ".edec.";
