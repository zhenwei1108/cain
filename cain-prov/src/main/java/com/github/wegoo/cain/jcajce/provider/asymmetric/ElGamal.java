...
import com.github.wegoo.cain.jcajce.provider.asymmetric.elgamal.KeyFactorySpi;
...
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric" + ".elgamal.";
