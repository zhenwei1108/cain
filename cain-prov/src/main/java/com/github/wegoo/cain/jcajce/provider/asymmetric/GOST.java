...
import com.github.wegoo.cain.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "com.github.wegoo.cain.jcajce.provider.asymmetric" + ".gost.";
