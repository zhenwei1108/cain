...
import com.github.wegoo.cain.crypto.generators.DSAKeyPairGenerator;
import com.github.wegoo.cain.crypto.generators.DSAParametersGenerator;
import com.github.wegoo.cain.crypto.params.DSAKeyGenerationParameters;
import com.github.wegoo.cain.crypto.params.DSAParameterGenerationParameters;
    ...
    extends java.security.KeyPairGenerator
{
        ...
        SecureRandom random)
    {
        ...
        DSAParameterSpec spec = CainJCEProvider.CONFIGURATION.getDSADefaultParameters(strength);
                ...
                synchronized (lock)
                {
                    ...
                    else
                    {
                        ...
                        if (strength == 1024)
                        {
                            ...
                            if (Properties.isOverrideSet("com.github.wegoo.cain.dsa.FIPS186-2for1024bits"))
                            {
