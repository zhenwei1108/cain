    ...
    implements ECPrivateKey, com.github.wegoo.cain.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public byte[] getEncoded()
    {
        ...
        if (ecSpec instanceof ECNamedCurveSpec)
        {
            ...
            orderBitLength = ECUtil.getOrderBitLength(CainJCEProvider.CONFIGURATION, ecSpec.getOrder(), this.getS());
        }
        else if (ecSpec == null)
        {
            params = new X962Parameters(DERNull.INSTANCE);
            orderBitLength = ECUtil.getOrderBitLength(CainJCEProvider.CONFIGURATION, null, this.getS());
        }
        else
        {
