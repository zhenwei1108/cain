...
public class BCDSTU4145PublicKey
    implements ECPublicKey, com.github.wegoo.cain.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    public BCDSTU4145PublicKey(
        com.github.wegoo.cain.jce.spec.ECPublicKeySpec spec,
        ProviderConfiguration configuration)
    {
        ...
        {
            com.github.wegoo.cain.jce.spec.ECParameterSpec s = configuration.getEcImplicitlyCa();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        com.github.wegoo.cain.jce.spec.ECParameterSpec spec = null;
        X9ECParameters x9Params = null;

        if (seq.getObjectAt(0) instanceof ASN1Integer)
        {
            x9Params = X9ECParameters.getInstance(seq);
            spec = new  com.github.wegoo.cain.jce.spec.ECParameterSpec(x9Params.getCurve(), x9Params.getG(), x9Params.getN(), x9Params.getH(), x9Params.getSeed());
        }
        else
        {
            ...
            else
            {
                ...
                spec = new com.github.wegoo.cain.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
            }
        }
    ...
    public com.github.wegoo.cain.math.ec.ECPoint getQ()
    {
        com.github.wegoo.cain.math.ec.ECPoint q = ecPublicKey.getQ();
