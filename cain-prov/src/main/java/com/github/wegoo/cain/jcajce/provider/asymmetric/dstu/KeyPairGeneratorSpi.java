...
import com.github.wegoo.cain.crypto.generators.DSTU4145KeyPairGenerator;
import com.github.wegoo.cain.crypto.generators.ECKeyPairGenerator;
import com.github.wegoo.cain.crypto.params.DSTU4145Parameters;
...
import com.github.wegoo.cain.jcajce.spec.DSTU4145ParameterSpec;
    ...
    extends java.security.KeyPairGenerator
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        else if (params == null && CainJCEProvider.CONFIGURATION.getEcImplicitlyCa() != null)
        {
            ECParameterSpec p = CainJCEProvider.CONFIGURATION.getEcImplicitlyCa();
            this.ecParams = params;
