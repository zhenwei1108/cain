    ...
    extends java.security.AlgorithmParametersSpi
{
        ...
        throws InvalidParameterSpecException
    {
        if (algorithmParameterSpec instanceof ECGenParameterSpec)
        {
            ...
            ProviderConfiguration configuration = CainJCEProvider.CONFIGURATION;
        ...
        throws IOException
    {
        if (isASN1FormatString(format))
        {
            ...
            ECCurve curve = EC5Util.getCurve(CainJCEProvider.CONFIGURATION, params);
        ...
        throws IOException
    {
        if (isASN1FormatString(format))
        {
            ...
            {
                com.github.wegoo.cain.jce.spec.ECParameterSpec ecSpec = EC5Util.convertSpec(ecParameterSpec);
