...
import com.github.wegoo.cain.crypto.util.OpenSSHPublicKeyUtil;
import com.github.wegoo.cain.jcajce.provider.asymmetric.util.BaseKeyFactorySpi;
...
import com.github.wegoo.cain.jcajce.spec.OpenSSHPrivateKeySpec;
import com.github.wegoo.cain.jcajce.spec.OpenSSHPublicKeySpec;
import com.github.wegoo.cain.jce.provider.CainJCEProvider;
import com.github.wegoo.cain.jce.spec.ECParameterSpec;
import com.github.wegoo.cain.jce.spec.ECPrivateKeySpec;
import com.github.wegoo.cain.jce.spec.ECPublicKeySpec;
    ...
    implements AsymmetricKeyInfoConverter
{
        ...
        throws InvalidKeySpecException
    {
        if ((spec.isAssignableFrom(KeySpec.class) || spec.isAssignableFrom(java.security.spec.ECPublicKeySpec.class)) && key instanceof ECPublicKey)
        {
            ...
            {
                ECParameterSpec implicitSpec = CainJCEProvider.CONFIGURATION.getEcImplicitlyCa();
        ...
        else if (spec.isAssignableFrom(com.github.wegoo.cain.jce.spec.ECPublicKeySpec.class) && key instanceof ECPublicKey)
        {
            ECPublicKey k = (ECPublicKey)key;
            if (k.getParams() != null)
            {
                return new com.github.wegoo.cain.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW()), EC5Util.convertSpec(k.getParams()));
            }
            else
            {
                ECParameterSpec implicitSpec = CainJCEProvider.CONFIGURATION.getEcImplicitlyCa();

                return new com.github.wegoo.cain.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW()), implicitSpec);
            }
        }
        else if (spec.isAssignableFrom(com.github.wegoo.cain.jce.spec.ECPrivateKeySpec.class) && key instanceof ECPrivateKey)
        {
            ECPrivateKey k = (ECPrivateKey)key;

            if (k.getParams() != null)
            {
                return new com.github.wegoo.cain.jce.spec.ECPrivateKeySpec(k.getS(), EC5Util.convertSpec(k.getParams()));
            }
            else
            {
                ECParameterSpec implicitSpec = CainJCEProvider.CONFIGURATION.getEcImplicitlyCa();

                return new com.github.wegoo.cain.jce.spec.ECPrivateKeySpec(k.getS(), implicitSpec);
            }
        }
        ...
        throws InvalidKeySpecException
    {
        ...
        {
            com.github.wegoo.cain.asn1.sec.ECPrivateKey ecKey = com.github.wegoo.cain.asn1.sec.ECPrivateKey.getInstance(((OpenSSHPrivateKeySpec)keySpec).getEncoded());
        ...
        extends KeyFactorySpi
    {
        public EC()
        {
            super("EC", CainJCEProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECDSA()
        {
            super("ECDSA", CainJCEProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECGOST3410()
        {
            super("ECGOST3410", CainJCEProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        ...
        {
            super("ECGOST3410-2012", CainJCEProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECDH()
        {
            super("ECDH", CainJCEProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECDHC()
        {
            super("ECDHC", CainJCEProvider.CONFIGURATION);
        }
    }
        ...
        extends KeyFactorySpi
    {
        public ECMQV()
        {
            super("ECMQV", CainJCEProvider.CONFIGURATION);
        }
    }
}