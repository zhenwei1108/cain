...
import com.github.wegoo.cain.jce.ECGOST3410NamedCurveTable;
...
public class EC5Util
{
        ...
        java.security.spec.ECParameterSpec params)
    {
        ...
        if (params == null)
        {
            com.github.wegoo.cain.jce.spec.ECParameterSpec iSpec = configuration.getEcImplicitlyCa();
        ...
        X962Parameters params, ECCurve curve)
    {
        ...
        if (params.isNamedCurve())
        {
            ...
            if (ecP == null)
            {
                Map additionalECParameters = CainJCEProvider.CONFIGURATION.getAdditionalECParameters();
    ...
    public static com.github.wegoo.cain.jce.spec.ECParameterSpec convertSpec(ECParameterSpec ecSpec)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        com.github.wegoo.cain.math.ec.ECPoint g = convertPoint(curve, ecSpec.getGenerator());
        ...
        {
            return new com.github.wegoo.cain.jce.spec.ECNamedCurveParameterSpec(((ECNamedCurveSpec)ecSpec).getName(), curve,
                g, n, h, seed);
        }
        else
        {
            return new com.github.wegoo.cain.jce.spec.ECParameterSpec(curve, g, n, h, seed);
        }
    }

    public static com.github.wegoo.cain.math.ec.ECPoint convertPoint(ECParameterSpec ecSpec, ECPoint point)
    {
        return convertPoint(convertCurve(ecSpec.getCurve()), point);
    }

    public static com.github.wegoo.cain.math.ec.ECPoint convertPoint(ECCurve curve, ECPoint point)
    {
        return curve.createPoint(point.getAffineX(), point.getAffineY());
    }

    public static ECPoint convertPoint(com.github.wegoo.cain.math.ec.ECPoint point)
    {
