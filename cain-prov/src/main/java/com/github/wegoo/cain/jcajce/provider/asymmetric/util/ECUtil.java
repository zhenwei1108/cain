...
public class ECUtil
{
    ...
    public static ECDomainParameters getDomainParameters(
        ...
        com.github.wegoo.cain.jce.spec.ECParameterSpec params)
    {
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            ...
            try
            {
                ...
                PublicKey publicKey = CainJCEProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(bytes));
        ...
        throws InvalidKeyException
    {
        ...
        else
        {
            ...
            try
            {
                ...
                PrivateKey privateKey = CainJCEProvider.getPrivateKey(PrivateKeyInfo.getInstance(bytes));
        ...
        ECParameterSpec ecParameterSpec)
    {
        for (Enumeration names = ECNamedCurveTable.getNames(); names.hasMoreElements();)
        {
            ...
            {
                return com.github.wegoo.cain.asn1.x9.ECNamedCurveTable.getOID(name);
            }
        }
    ...
    public static String privateKeyToString(String algorithm, BigInteger d, com.github.wegoo.cain.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();

        com.github.wegoo.cain.math.ec.ECPoint q = new FixedPointCombMultiplier().multiply(spec.getG(), d).normalize();
    ...
    public static String publicKeyToString(String algorithm, com.github.wegoo.cain.math.ec.ECPoint q, com.github.wegoo.cain.jce.spec.ECParameterSpec spec)
    {
        StringBuffer buf = new StringBuffer();
        String nl = Strings.lineSeparator();
    ...
    public static String generateKeyFingerprint(ECPoint publicPoint, com.github.wegoo.cain.jce.spec.ECParameterSpec spec)
    {
