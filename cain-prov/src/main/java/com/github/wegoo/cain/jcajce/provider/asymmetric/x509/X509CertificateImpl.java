...
import com.github.wegoo.cain.internal.asn1.misc.NetscapeCertType;
import com.github.wegoo.cain.internal.asn1.misc.NetscapeRevocationURL;
import com.github.wegoo.cain.internal.asn1.misc.VerisignCzagExtension;
import com.github.wegoo.cain.jcajce.CompositePublicKey;
import com.github.wegoo.cain.jcajce.interfaces.BCX509Certificate;
import com.github.wegoo.cain.jcajce.io.OutputStreamFactory;
import com.github.wegoo.cain.jcajce.util.JcaJceHelper;
import com.github.wegoo.cain.jce.X509Principal;
    ...
    implements BCX509Certificate
{
    ...
    protected com.github.wegoo.cain.asn1.x509.Certificate c;
    protected BasicConstraints basicConstraints;
    protected boolean[] keyUsage;
    protected String sigAlgName;
    protected byte[] sigAlgParams;
    X509CertificateImpl(JcaJceHelper bcHelper, com.github.wegoo.cain.asn1.x509.Certificate c,
    ...
    public PublicKey getPublicKey()
    {
        try
        {
            return CainJCEProvider.getPublicKey(c.getSubjectPublicKeyInfo());
        }
        catch (IOException e)
        {
    ...
    private static Collection getAlternativeNames(com.github.wegoo.cain.asn1.x509.Certificate c, String oid)
        throws CertificateParsingException
    {
    ...
    protected static byte[] getExtensionOctets(com.github.wegoo.cain.asn1.x509.Certificate c, String oid)
    {
        ASN1OctetString extValue = getExtensionValue(c, oid);
        if (null != extValue)
        {
    ...
    protected static ASN1OctetString getExtensionValue(com.github.wegoo.cain.asn1.x509.Certificate c, String oid)
    {
