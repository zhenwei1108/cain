package com.github.wegoo.cain.jcajce.provider.keystore.bc;
...
import com.github.wegoo.cain.crypto.io.DigestInputStream;
import com.github.wegoo.cain.crypto.io.DigestOutputStream;
import com.github.wegoo.cain.crypto.io.MacInputStream;
    ...
    implements BCKeyStore
{
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            {
            case KEY_PRIVATE:
                return CainJCEProvider.getPrivateKey(PrivateKeyInfo.getInstance(enc));
            case KEY_PUBLIC:
                return  CainJCEProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(enc));
            case KEY_SECRET:
