package com.github.wegoo.cain.jcajce.provider.keystore.bcfks;
...
import com.github.wegoo.cain.asn1.ASN1InputStream;
import com.github.wegoo.cain.asn1.ASN1ObjectIdentifier;
import com.github.wegoo.cain.asn1.DERNull;
import com.github.wegoo.cain.asn1.bc.EncryptedObjectStoreData;
import com.github.wegoo.cain.asn1.bc.EncryptedPrivateKeyData;
import com.github.wegoo.cain.asn1.bc.EncryptedSecretKeyData;
import com.github.wegoo.cain.asn1.bc.ObjectData;
import com.github.wegoo.cain.asn1.bc.ObjectDataSequence;
import com.github.wegoo.cain.asn1.bc.ObjectStore;
import com.github.wegoo.cain.asn1.bc.ObjectStoreData;
import com.github.wegoo.cain.asn1.bc.ObjectStoreIntegrityCheck;
import com.github.wegoo.cain.asn1.bc.PbkdMacIntegrityCheck;
import com.github.wegoo.cain.asn1.bc.SecretKeyData;
import com.github.wegoo.cain.asn1.bc.SignatureCheck;
...
import com.github.wegoo.cain.asn1.pkcs.EncryptionScheme;
import com.github.wegoo.cain.asn1.pkcs.KeyDerivationFunc;
import com.github.wegoo.cain.asn1.pkcs.PBES2Parameters;
...
import com.github.wegoo.cain.crypto.generators.SCrypt;
import com.github.wegoo.cain.crypto.params.KeyParameter;
import com.github.wegoo.cain.crypto.util.PBKDF2Config;
import com.github.wegoo.cain.crypto.util.PBKDFConfig;
import com.github.wegoo.cain.crypto.util.ScryptConfig;
import com.github.wegoo.cain.internal.asn1.cms.CCMParameters;
import com.github.wegoo.cain.internal.asn1.kisa.KISAObjectIdentifiers;
import com.github.wegoo.cain.internal.asn1.misc.MiscObjectIdentifiers;
import com.github.wegoo.cain.internal.asn1.misc.ScryptParams;
import com.github.wegoo.cain.internal.asn1.nsri.NSRIObjectIdentifiers;
...
import com.github.wegoo.cain.jcajce.BCFKSLoadStoreParameter;
import com.github.wegoo.cain.jcajce.BCFKSStoreParameter;
import com.github.wegoo.cain.jcajce.BCLoadStoreParameter;
import com.github.wegoo.cain.jcajce.provider.keystore.util.AdaptingKeyStoreSpi;
import com.github.wegoo.cain.jcajce.provider.keystore.util.ParameterUtil;
    ...
    extends KeyStoreSpi
{
    ...
    public Certificate[] engineGetCertificateChain(String alias)
    {
        ...
        if (ent != null)
        {
            ...
            {
                EncryptedPrivateKeyData encPrivData = EncryptedPrivateKeyData.getInstance(ent.getData());
                com.github.wegoo.cain.asn1.x509.Certificate[] certificates = encPrivData.getCertificateChain();
    ...
    private Certificate decodeCertificate(Object cert)
    {
        if (helper != null)
        {
            try
            {
                ...
                return certFact.generateCertificate(new ByteArrayInputStream(com.github.wegoo.cain.asn1.x509.Certificate.getInstance(cert).getEncoded()));
            }
            catch (Exception e)
            {
                return null;
    ...
    {
        com.github.wegoo.cain.asn1.x509.Certificate[] certChain = new com.github.wegoo.cain.asn1.x509.Certificate[chain.length];
        for (int i = 0; i != chain.length; i++)
        {
            certChain[i] = com.github.wegoo.cain.asn1.x509.Certificate.getInstance(chain[i].getEncoded());
        }
        ...
        else if (parameter instanceof BCFKSLoadStoreParameter)
        {
            ...
            if (bcParam.getStoreSignatureKey() != null)
            {
                ...
                try
                {
                    ...
                    if (certs != null)
                    {
                        com.github.wegoo.cain.asn1.x509.Certificate[] certificates = new com.github.wegoo.cain.asn1.x509.Certificate[certs.length];
                        for (int i = 0; i != certificates.length; i++)
                        {
                            certificates[i] = com.github.wegoo.cain.asn1.x509.Certificate.getInstance(certs[i].getEncoded());
                        }
        ...
        throws IOException, NoSuchAlgorithmException, CertificateException
    {
        ...
        else if (integrityCheck.getType() == ObjectStoreIntegrityCheck.SIG_CHECK)
        {
            ...
            try
            {
                com.github.wegoo.cain.asn1.x509.Certificate[] certificates = sigCheck.getCertificates();
                if (validator != null)
                {
