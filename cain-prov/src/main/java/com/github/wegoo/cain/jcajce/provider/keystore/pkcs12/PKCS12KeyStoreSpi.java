package com.github.wegoo.cain.jcajce.provider.keystore.pkcs12;
...
import com.github.wegoo.cain.asn1.ASN1BMPString;
...
import com.github.wegoo.cain.asn1.BERSequence;
import com.github.wegoo.cain.asn1.DERBMPString;
...
import com.github.wegoo.cain.asn1.pkcs.AuthenticatedSafe;
import com.github.wegoo.cain.asn1.pkcs.CertBag;
import com.github.wegoo.cain.asn1.pkcs.ContentInfo;
import com.github.wegoo.cain.asn1.pkcs.EncryptedData;
...
import com.github.wegoo.cain.asn1.pkcs.Pfx;
import com.github.wegoo.cain.asn1.pkcs.SafeBag;
import com.github.wegoo.cain.asn1.util.ASN1Dump;
...
import com.github.wegoo.cain.asn1.x509.ExtendedKeyUsage;
import com.github.wegoo.cain.asn1.x509.Extension;
import com.github.wegoo.cain.asn1.x509.Extensions;
import com.github.wegoo.cain.asn1.x509.KeyPurposeId;
import com.github.wegoo.cain.asn1.x509.SubjectKeyIdentifier;
import com.github.wegoo.cain.asn1.x509.SubjectPublicKeyInfo;
import com.github.wegoo.cain.asn1.x509.TBSCertificate;
...
import com.github.wegoo.cain.jcajce.PKCS12StoreParameter;
...
import com.github.wegoo.cain.jcajce.spec.PBKDF2KeySpec;
...
import com.github.wegoo.cain.jce.interfaces.BCKeyStore;
...
import com.github.wegoo.cain.jce.provider.JDKPKCS12StoreParameter;
...
{
    static final String PKCS12_MAX_IT_COUNT_PROPERTY = "com.github.wegoo.cain.pkcs12.max_it_count";
        ...
        throws IOException
    {
        ...
        if (noMac && noEnc)
        {
            ...
            {
                if (!Properties.isOverrideSet("com.github.wegoo.cain.pkcs12.ignore_useless_passwd"))
                {
    ...
    private boolean processShroudedKeyBag(SafeBag b, char[] password, boolean wrongPKCS12Zero)
        throws IOException
    {
        com.github.wegoo.cain.asn1.pkcs.EncryptedPrivateKeyInfo eIn = com.github.wegoo.cain.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
    ...
    private void processKeyBag(SafeBag b)
        throws IOException
    {
        com.github.wegoo.cain.asn1.pkcs.PrivateKeyInfo kInfo = com.github.wegoo.cain.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
        PrivateKey privKey = CainJCEProvider.getPrivateKey(kInfo);
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            com.github.wegoo.cain.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new com.github.wegoo.cain.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
