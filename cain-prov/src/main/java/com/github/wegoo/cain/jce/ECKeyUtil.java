        ...
        throws IllegalArgumentException, NoSuchAlgorithmException
    {
        try
        {
            ...
            else
            {
                ...
                {
                    curveParams = new X9ECParameters(
                        CainJCEProvider.CONFIGURATION.getEcImplicitlyCa().getCurve(),
                        new X9ECPoint(CainJCEProvider.CONFIGURATION.getEcImplicitlyCa().getG(), false),
                        CainJCEProvider.CONFIGURATION.getEcImplicitlyCa().getN(),
                        CainJCEProvider.CONFIGURATION.getEcImplicitlyCa().getH());
                }
                else
                {
