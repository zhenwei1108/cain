package com.github.wegoo.cain.jce;
 ...
 *  }
 * </pre>
 * @deprecated use classes in com.github.wegoo.cain.pkcs.
 */
    ...
    extends CertificationRequest
{
    ...
    {
        this(signatureAlgorithm, subject, key, attributes, signingKey, CainJCEProvider.PROVIDER_NAME);
    }
    ...
    public PKCS10CertificationRequest(
        ...
        throws NoSuchAlgorithmException, NoSuchProviderException,
                InvalidKeyException, SignatureException
    {
        this(signatureAlgorithm, convertName(subject), key, attributes, signingKey, CainJCEProvider.PROVIDER_NAME);
    }
    ...
    {
        return getPublicKey(CainJCEProvider.PROVIDER_NAME);
    }
    ...
    public boolean verify()
        throws NoSuchAlgorithmException, NoSuchProviderException,
                InvalidKeyException, SignatureException
    {
        return verify(CainJCEProvider.PROVIDER_NAME);
    }
