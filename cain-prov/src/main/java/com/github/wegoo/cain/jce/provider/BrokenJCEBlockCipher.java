...
import com.github.wegoo.cain.crypto.engines.TwofishEngine;
    ...
    implements BrokenPBE
{
    ...
    protected AlgorithmParameters engineGetParameters() 
    {
        if (engineParams == null)
        {
            if (ivParam != null)
            {
                ...
                try
                {
                    engineParams = AlgorithmParameters.getInstance(name, CainJCEProvider.PROVIDER_NAME);
    ...
    throws InvalidKeyException
    {
        ...
        else
        {
            try
            {
                KeyFactory kf = KeyFactory.getInstance(wrappedKeyAlgorithm, CainJCEProvider.PROVIDER_NAME);
