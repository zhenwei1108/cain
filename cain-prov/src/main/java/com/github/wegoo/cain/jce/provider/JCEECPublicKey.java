    ...
    implements ECPublicKey, com.github.wegoo.cain.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private com.github.wegoo.cain.math.ec.ECPoint q;
        ...
        com.github.wegoo.cain.jce.spec.ECPublicKeySpec     spec)
    {
        ...
        else
        {
            if (q.getCurve() == null)
            {
                com.github.wegoo.cain.jce.spec.ECParameterSpec s = CainJCEProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        else
        {
            ...
            {
                ecSpec = null;
                curve = CainJCEProvider.CONFIGURATION.getEcImplicitlyCa().getCurve();
            }
            else
            {
    ...
    public com.github.wegoo.cain.math.ec.ECPoint engineGetQ()
    {
        return q;
    }
