    ...
    implements RSAPrivateCrtKey
{
    ...
    /**
     * construct a private key from it's com.github.wegoo.cain.crypto equivalent.
     *
    ...
    JCERSAPrivateCrtKey(
        ...
        throws IOException
    {
        this(com.github.wegoo.cain.asn1.pkcs.RSAPrivateKey.getInstance(info.parsePrivateKey()));
    }
