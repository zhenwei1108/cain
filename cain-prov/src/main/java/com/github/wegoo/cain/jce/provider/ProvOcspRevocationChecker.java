...
import com.github.wegoo.cain.asn1.ASN1GeneralizedTime;
...
import com.github.wegoo.cain.asn1.ocsp.BasicOCSPResponse;
import com.github.wegoo.cain.asn1.ocsp.CertID;
import com.github.wegoo.cain.asn1.ocsp.OCSPObjectIdentifiers;
import com.github.wegoo.cain.asn1.ocsp.OCSPResponse;
import com.github.wegoo.cain.asn1.ocsp.OCSPResponseStatus;
import com.github.wegoo.cain.asn1.ocsp.ResponderID;
import com.github.wegoo.cain.asn1.ocsp.ResponseBytes;
import com.github.wegoo.cain.asn1.ocsp.ResponseData;
import com.github.wegoo.cain.asn1.ocsp.RevokedInfo;
import com.github.wegoo.cain.asn1.ocsp.SingleResponse;
...
import com.github.wegoo.cain.asn1.x500.style.BCStrictStyle;
import com.github.wegoo.cain.asn1.x509.AccessDescription;
import com.github.wegoo.cain.asn1.x509.AlgorithmIdentifier;
import com.github.wegoo.cain.asn1.x509.AuthorityInformationAccess;
import com.github.wegoo.cain.asn1.x509.CRLReason;
...
import com.github.wegoo.cain.internal.asn1.bsi.BSIObjectIdentifiers;
import com.github.wegoo.cain.internal.asn1.eac.EACObjectIdentifiers;
...
import com.github.wegoo.cain.internal.asn1.rosstandart.RosstandartObjectIdentifiers;
...
import com.github.wegoo.cain.jce.exception.ExtCertPathValidatorException;
    ...
    implements PKIXCertRevocationChecker
{
        ...
        throws CertPathValidatorException
    {
        ...
        if (ocspResponses.get(cert) == null && ocspUri != null)
        {
            ...
            com.github.wegoo.cain.asn1.x509.Certificate issuer = extractCert();
    ...
    {
        byte[] extValue = cert.getExtensionValue(com.github.wegoo.cain.asn1.x509.Extension.authorityInfoAccess.getId());
        if (extValue == null)
        {
            return null;
        }
        ...
        try
        {
            ...
            if (sig.verify(basicResp.getSignature().getOctets()))
            {
                if (nonce != null)
                {
                    ...
                    com.github.wegoo.cain.asn1.x509.Extension ext = exts.getExtension(OCSPObjectIdentifiers.id_pkix_ocsp_nonce);
    ...
    private com.github.wegoo.cain.asn1.x509.Certificate extractCert()
        throws CertPathValidatorException
    {
        try
        {
            return com.github.wegoo.cain.asn1.x509.Certificate.getInstance(parameters.getSigningCert().getEncoded());
        }
        catch (Exception e)
        {
    ...
    private CertID createCertID(CertID base, com.github.wegoo.cain.asn1.x509.Certificate issuer, ASN1Integer serialNumber)
        throws CertPathValidatorException
    {
        return createCertID(base.getHashAlgorithm(), issuer, serialNumber);
    }

    private CertID createCertID(AlgorithmIdentifier digestAlg, com.github.wegoo.cain.asn1.x509.Certificate issuer, ASN1Integer serialNumber)
        throws CertPathValidatorException
    {
        try
        {
