...
import com.github.wegoo.cain.asn1.x509.TargetInformation;
import com.github.wegoo.cain.asn1.x509.X509Extensions;
...
import com.github.wegoo.cain.x509.PKIXAttrCertChecker;
...
class RFC3281CertPathUtilities
{
        ...
        throws CertPathValidatorException
    {
        ...
        try
        {
            validator = CertPathValidator.getInstance("PKIX", CainJCEProvider.PROVIDER_NAME);
        }
        ...
        throws CertPathValidatorException
    {
        ...
        for (Iterator it = holderPKCs.iterator(); it.hasNext();)
        {
            ...
            try
            {
                builder = CertPathBuilder.getInstance("PKIX", CainJCEProvider.PROVIDER_NAME);
            }
            catch (NoSuchProviderException e)
            {
                throw new ExtCertPathValidatorException(
