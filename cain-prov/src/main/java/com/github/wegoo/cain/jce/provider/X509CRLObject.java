...
import com.github.wegoo.cain.asn1.x509.CRLNumber;
...
import com.github.wegoo.cain.asn1.x509.TBSCertList;
    ...
    extends X509CRL
{
        ...
        InvalidKeyException, NoSuchProviderException, SignatureException
    {
        ...
        try
        {
            sig = Signature.getInstance(getSigAlgName(), CainJCEProvider.PROVIDER_NAME);
        }
        catch (Exception e)
        {
            ...
            while (certs.hasMoreElements())
            {
                ...
                if (entry.getUserCertificate().hasValue(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = com.github.wegoo.cain.asn1.x509.Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
