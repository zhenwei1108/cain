...
/**
 * @deprecated Do not use this class directly - either use com.github.wegoo.cain.cert (bcpkix) or CertificateFactory.
 */
public class X509CertificateObject
    extends X509Certificate
    implements PKCS12BagAttributeCarrier
{
    private com.github.wegoo.cain.asn1.x509.Certificate    c;
    ...
    public X509CertificateObject(
        com.github.wegoo.cain.asn1.x509.Certificate    c)
        ...
        InvalidKeyException, NoSuchProviderException, SignatureException
    {
        ...
        try
        {
            signature = Signature.getInstance(sigName, CainJCEProvider.PROVIDER_NAME);
        }
        catch (Exception e)
        {
