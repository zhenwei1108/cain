...
import com.github.wegoo.cain.math.Primes;
import com.github.wegoo.cain.math.ec.endo.ECEndomorphism;
import com.github.wegoo.cain.math.ec.endo.GLVEndomorphism;
import com.github.wegoo.cain.math.field.FiniteField;
import com.github.wegoo.cain.math.field.FiniteFields;
import com.github.wegoo.cain.math.raw.Nat;
...
public abstract class ECCurve
{
    ...
    public static class Fp extends AbstractFp
    {
        ...
        public Fp(BigInteger q, BigInteger a, BigInteger b, BigInteger order, BigInteger cofactor, boolean isInternal)
        {
            ...
            {
                int maxBitLength = Properties.asInteger("com.github.wegoo.cain.ec.fp_max_size", 1042); // 2 * 521
                int certainty = Properties.asInteger("com.github.wegoo.cain.ec.fp_certainty", 100);
    ...
    public static abstract class AbstractF2m extends ECCurve
    {
        ...
        {
            if (m > Properties.asInteger("com.github.wegoo.cain.ec.max_f2m_field_size", 1142))  // twice 571
            {
        ...
        protected AbstractF2m(int m, int k1, int k2, int k3)
        {
            ...
            if (Properties.isOverrideSet("com.github.wegoo.cain.ec.disable"))
            {
                throw new UnsupportedOperationException("F2M disabled by \"com.github.wegoo.cain.ec.disable\"");
            }
            if (Properties.isOverrideSet("com.github.wegoo.cain.ec.disable_f2m"))
            {
                throw new UnsupportedOperationException("F2M disabled by \"com.github.wegoo.cain.ec.disable_f2m\"");
            }
        }
