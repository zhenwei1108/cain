...
import static com.github.wegoo.cain.pqc.crypto.lms.HSS.rangeTestKeys;
    ...
    implements LMSContextBasedSigner
{
    ...
    void resetKeyToIndex()
    {
        ...
        for (int i = 1; i < qTreePath.length; i++)
        {
            ...
            //
            boolean seedEquals = com.github.wegoo.cain.util.Arrays.areEqual(childI, keys[i].getI())
                && com.github.wegoo.cain.util.Arrays.areEqual(childSeed, keys[i].getMasterSecret());
