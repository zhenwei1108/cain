...
public class XMSSUtil
{
       ...
       extends ObjectInputStream
    {
        ...
        static
        {
            ...
            components.add("com.github.wegoo.cain.pqc.crypto.xmss.BDS");
            components.add("java.util.ArrayList");
            components.add("com.github.wegoo.cain.pqc.crypto.xmss.XMSSNode");
            components.add("[B");
            ...
            components.add("com.github.wegoo.cain.pqc.crypto.xmss.BDSTreeHash");
        }
