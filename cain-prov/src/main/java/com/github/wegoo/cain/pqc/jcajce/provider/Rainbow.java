...
import com.github.wegoo.cain.pqc.jcajce.provider.rainbow.RainbowKeyFactorySpi;

public class Rainbow
{
    private static final String PREFIX = "com.github.wegoo.cain.pqc.jcajce.provider" + ".rainbow.";
