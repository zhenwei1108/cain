    ...
    implements AsymmetricKeyInfoConverter
{
    ...
    public final KeySpec engineGetKeySpec(Key key, Class keySpec)
            throws InvalidKeySpecException
    {
        if (key instanceof com.github.wegoo.cain.pqc.jcajce.provider.frodo.BCFrodoPrivateKey)
        {
        ...
        else if (key instanceof com.github.wegoo.cain.pqc.jcajce.provider.frodo.BCFrodoPublicKey)
        {
    ...
    {
        if (key instanceof com.github.wegoo.cain.pqc.jcajce.provider.frodo.BCFrodoPrivateKey || key instanceof com.github.wegoo.cain.pqc.jcajce.provider.frodo.BCFrodoPublicKey)
        {
            return key;
        }
