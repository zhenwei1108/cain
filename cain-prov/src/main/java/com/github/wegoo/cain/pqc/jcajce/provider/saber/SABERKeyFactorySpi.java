        ...
        implements AsymmetricKeyInfoConverter
{
    ...
    public final KeySpec engineGetKeySpec(Key key, Class keySpec)
            throws InvalidKeySpecException
    {
        if (key instanceof com.github.wegoo.cain.pqc.jcajce.provider.saber.BCSABERPrivateKey)
        {
        ...
        else if (key instanceof com.github.wegoo.cain.pqc.jcajce.provider.saber.BCSABERPublicKey)
        {
    ...
    {
        if (key instanceof com.github.wegoo.cain.pqc.jcajce.provider.saber.BCSABERPrivateKey || key instanceof com.github.wegoo.cain.pqc.jcajce.provider.saber.BCSABERPublicKey)
        {
            return key;
        }
