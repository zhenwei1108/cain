...
import com.github.wegoo.cain.asn1.x509.X509Extension;
...
//    protected static final String AUTHORITY_KEY_IDENTIFIER = Extension.authorityKeyIdentifier.getId();
    ...
    */
     ...
     *         {@link com.github.wegoo.cain.x509.X509AttributeCertificate} objects.
        ...
        throws AnnotatedException
    {
        ...
        com.github.wegoo.cain.jcajce.provider.asymmetric.x509.CertificateFactory certFact = new com.github.wegoo.cain.jcajce.provider.asymmetric.x509.CertificateFactory();
        ...
        throws CertPathValidatorException
    {
        ...
        for (int i = index + 1; i < certs.size(); i++)
        {
            ...
            try
            {
                KeyFactory keyFactory = KeyFactory.getInstance("DSA", CainJCEProvider.PROVIDER_NAME);
